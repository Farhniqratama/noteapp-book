import{b as d,s as m,S as c,r as g}from"./storyApi-1rK2hKwQ.js";class u{constructor(e){this.view=e}async login(e,s){var t,a,n,r;try{const i=await d(e,s);m(i.token),c.setUserName(i.name||""),(a=(t=this.view)==null?void 0:t.onLoginSuccess)==null||a.call(t,i.name)}catch(i){(r=(n=this.view)==null?void 0:n.onError)==null||r.call(n,(i==null?void 0:i.message)||"Gagal login")}}async register(e,s,t){var a,n,r,i;try{await g(e,s,t),(n=(a=this.view)==null?void 0:a.onRegisterSuccess)==null||n.call(a)}catch(o){(i=(r=this.view)==null?void 0:r.onError)==null||i.call(r,(o==null?void 0:o.message)||"Gagal registrasi")}}}class p{async render(e){e.innerHTML=`
...
//# sourceMappingURL=AuthView-CtzKbAeB.js.map
