...
/* token disentral-kan di model (bkn di presenter/view) */
export function getToken(){ return localStorage.getItem('token') }
export function setToken(token){ token ? localStorage.setItem('token', token) : null }
...
/* opsional endpoint guest jika ada */
